...
var isAdminOrHasAccesToImages = function () { return function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user;
    var req = _b.req;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!req.user || !(referrer === null || referrer === void 0 ? void 0 : referrer.includes('sell'))) {
                            return [2 /*return*/, true];
                        }
                        return [4 /*yield*/, isAdminOrHasAccesToImages()({ req: req })];
