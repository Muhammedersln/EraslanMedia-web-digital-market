...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privatePrecudure
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, payload.create({
                            ...
                            data: {
                                _isPaid: false,
                                product: filteredProducts.map(function (prod) { return prod.id; }),
                                user: user.id
                            }
                        })];
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                            success_url: "".concat(process.env.NEXT_PUBLIC_URL, "/thank-you?orderId=").concat(order.id),
                            cancel_url: "".concat(process.env.NEXT_PUBLIC_URL, "/cart"),
