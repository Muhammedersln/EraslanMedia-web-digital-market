    ...
    return (
        <div className="flex">
            ...
            {/* {isOpen ? (
                ...
                <div className={cn("absolute inset-x-0 top-4 text-sm text-muted-foreground", {
                                    ...
                                    {category.featured.map((item) => (
                                        <div
                                            ...
                                            <div className="relative aspect-video overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                                <Image src={item.imageSrc} alt="kategori görseli"
                                            ...
                                            <p className="mt-1" aria-hidden="true">Alışveriş Yap</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
